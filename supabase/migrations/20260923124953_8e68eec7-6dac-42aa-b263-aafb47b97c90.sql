...
DROP POLICY IF EXISTS "Authorized staff create their own audit entries" ON public.audit_logs;
CREATE POLICY "Authorized staff create their own audit entries"
