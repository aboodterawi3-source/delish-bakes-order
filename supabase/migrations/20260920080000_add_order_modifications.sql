-- Add modifications column to orders table
ALTER TABLE public.orders ADD COLUMN IF NOT EXISTS modifications jsonb DEFAULT '[]'::jsonb;

-- Drop and recreate get_kitchen_orders function to return modifications
...
AS $$
  SELECT o.id, o.order_number, o.staff_code, o.customer_name, o.method,
         ...
         o.created_at, o.is_urgent, o.queue_rank, COALESCE(o.modifications, '[]'::jsonb)
